...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your_email@gmail.com'  # <-- Put your real Gmail here
EMAIL_HOST_PASSWORD = 'your_app_password' # <-- Put your App Password here (NOT your normal login password)
