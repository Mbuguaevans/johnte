...
def get_mpesa_access_token():
    ...
    try:
        ...
        print(f"DEBUG: Safaricom Token Auth Failed: {res.text}")
        return None
...
def initiate_stk_push(phone, amount, land_title):
    ...
    payload = {
        ...
        "AccountReference": land_title[:12],
        "TransactionDesc": f"Payment for {land_title}"
    }
    ...
    try:
        ...
        return {"error": "Connection to Safaricom timed out"}
